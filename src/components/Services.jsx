    ...
    <section id="services" className="py-28 px-4 bg-purple-700">
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={featuredRef} className="reveal mb-8">
          <div className="group bg-white border-4 border-black p-10 md:p-12 shadow-[12px_12px_0px_0px_rgba(163,230,53,1)] hover:shadow-[6px_6px_0px_0px_rgba(163,230,53,1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:border-lime-500 transition-all">
            <div className="mb-6 text-purple-600">
              <Star size={48} className="fill-current icon-spin-bounce" style={{ animation: 'none' }} />
            </div>
            <h3 className="text-4xl md:text-5xl font-display font-extrabold uppercase mb-4">Script Writing</h3>
            <p className="text-xl md:text-2xl font-bold text-gray-800 border-l-4 border-lime-500 pl-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div ref={card1Ref} className="reveal reveal-delay-1">
            <div className="group bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(163,230,53,1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:border-lime-500 transition-all h-full">
              <div className="mb-6 text-purple-600">
                <Play size={40} className="fill-current icon-click-press" style={{ animation: 'none' }} />
              </div>
              <h3 className="text-3xl font-display font-extrabold uppercase mb-4">Filming &amp; Editing</h3>
              <p className="text-lg font-bold text-gray-800 border-l-4 border-lime-500 pl-4">
          ...
          <div ref={card2Ref} className="reveal reveal-delay-2">
            <div className="group bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(163,230,53,1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:border-lime-500 transition-all h-full">
              <div className="mb-6 text-purple-600">
                <ArrowUpRight size={40} className="fill-current icon-arrow-launch" style={{ animation: 'none' }} />
              </div>
